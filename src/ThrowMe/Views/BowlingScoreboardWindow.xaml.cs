...
public partial class BowlingScoreboardWindow : Window
{
    ...
    private FrameworkElement BuildMonitor()
    {
        ...
        lowerBezel.Child = Text("THROWME  ·  BOWLING SYSTEM", 12, C("#4C5558"), FontWeights.SemiBold,
    ...
    private FrameworkElement BuildScreen()
    {
        ...
        var title = Text("THROWME BOWLING", 20, C("#EAF5FD"), FontWeights.Bold,
            HorizontalAlignment.Center, VerticalAlignment.Center);
    ...
    private FrameworkElement BuildTable()
    {
        ...
        playerStack.Children.Add(Text("THROWME", 17, Colors.White, FontWeights.Bold));
